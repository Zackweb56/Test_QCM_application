        ...
        <div class="row">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h2 class="text-secondary">Edit Options Page</h2>
                    ...
                    <form action="{{ route('options.update', $options->id) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group mb-2 col-lg-6">
                                ...
                                <input type="text" value="{{ $options->option_1 }}" class="form-control @error('option_1') border-danger @enderror" name="option_1" id="option_1" placeholder="enter option 1">
                                @error('option_1')
                            ...
                            <div class="form-group mb-2 col-lg-6">
                                ...
                                <input type="text" value="{{ $options->option_2 }}" class="form-control @error('option_2') border-danger @enderror" name="option_2" id="option_2" placeholder="enter option 2">
                                @error('option_3')
                                    <small class="fs-5 mt-1 text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group mb-2 col-lg-6">
                                ...
                                <input type="text" value="{{ $options->option_3 }}" class="form-control @error('option_3') border-danger @enderror" name="option_3" id="option_3" placeholder="enter option 3">
                                @error('option_3')
                                    <small class="fs-5 mt-1 text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group mb-2 col-lg-6">
                                ...
                                <input type="text" value="{{ $options->option_4 }}" class="form-control @error('option_4') border-danger @enderror" name="option_4" id="option_4" placeholder="enter option 4">
                                @error('option_4')
                                    <small class="fs-5 mt-1 text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                       ...
                       {{-- <div class="form-group mb-2 col-lg-12">
                            ...
                            <select class="form-select @error('correct_answer') border-danger @enderror" name="correct_answer" id="correct_answer">
                                ...
                                <option value="{{ $options->option_1 }}">{{ $options->option_1 }}</option>
                                <option value="{{ $options->option_2 }}">{{ $options->option_2 }}</option>
                                <option value="{{ $options->option_3 }}">{{ $options->option_3 }}</option>
                                <option value="{{ $options->option_4 }}">{{ $options->option_4 }}</option>
                            </select>
                        ...
                        <div class="form-group mb-2 col-lg-12">
                            <label class="fs-4" for="correct_answer">Correct Answer<span class="text-danger">*</span></label>
                            <input type="text" value="{{ $options->correct_answer }}" class="form-control @error('correct_answer') border-danger @enderror" name="correct_answer" id="correct_answer" placeholder="enter the correct answer">
                            @error('correct_answer')
                                <small class="fs-5 mt-1 text-danger">{{ $message }}</small>
                            @enderror
                        </div>
